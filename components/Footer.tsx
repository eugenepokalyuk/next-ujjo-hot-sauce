  ...
  <footer className="footer">
    <div>
      <div className="border border-black flex flex-col md:flex-row items-center justify-between py-5 px-[93px] bg-[#cdfd3b] gap-5 md:gap-0">
        ...
        <Link href="https://t.me/PaperCranejs" target="_blank" className="font-[400] text-[15px] leading-[24px] tracking-[0.5px] text-center uppercase text-black hover:text-black/60">Telegram</Link>
